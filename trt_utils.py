...
def onnx2trt(TRT_LOGGER, onnx_file_path, engine_file_path="", input_shapes=[], fp16=True, max_batch_size=1):
    with trt.Builder(TRT_LOGGER) as builder, builder.create_network(
        ...
        for idx, input_shape in enumerate(input_shapes):
            network.get_input(idx).shape = input_shape
