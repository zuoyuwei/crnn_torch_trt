...
def runOnnxModel(onnx_path = './onnx2trt/data/crnn_data/new_crnn.onnx', image_path = './data/demo.py'):
    # loading the image
    transformer = dataset.resizeNormalize((1000, 32))
...
def runTensorRTModel(onnx_path = './new_crnn.onnx', trt_path = './new_crnn.trt', image_path = './data/demo.png'):
...
def main():
    ...
    runTensorRTModel('./new_crnn.onnx', './new_crnn_english.trt', './data/demo.png')
